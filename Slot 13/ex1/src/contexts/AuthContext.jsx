/**
 * AuthContext - Quản lý authentication state cho toàn bộ ứng dụng
 * 
 * Tính năng:
 * - useReducer quản lý state: user, loading, error, isAuthenticated
 * - Mock data thay thế API call
 * - Login function với validation và phân quyền
 * - Promise-based để dễ sử dụng trong component
 */
